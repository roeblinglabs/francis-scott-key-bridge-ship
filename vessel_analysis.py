...
# Francis Scott Key Bridge location (Manually copy-pasted from Google Maps)
BRIDGE_LAT = 39.21729756703898
BRIDGE_LON = -76.5281100828754

# Francis Scott Key Bridge piers (Manually copy-pasted from Google Maps)
BOURNE_BRIDGE_PIERS = {
    'pier_14': {
        'name': 'Pier 14',
        'lat': 39.2133300353827,
        'lon': -76.53312882767675,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_15': {
        'name': 'Pier 15',
        'lat': 39.21392647492038,
        'lon': -76.53238040727507,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_16': {
        'name': 'Pier 16',
        'lat': 39.214542485825405,
        'lon': -76.53157615730638,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_17': {
        'name': 'Pier 17 (Main Span)',
        'lat': 39.215964605116355,
        'lon': -76.52978740069886,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_18': {
        'name': 'Pier 18 (Main Span)',
        'lat': 39.2182772027177,
        'lon': -76.52679818900903,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_19': {
        'name': 'Pier 19',
        'lat': 39.21965538864265,
        'lon': -76.52497108072626,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_20': {
        'name': 'Pier 20',
        'lat': 39.220214972173316,
        'lon': -76.5242435083227,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_21': {
        'name': 'Pier 21',
        'lat': 39.220781346206316,
        'lon': -76.52351172448708,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_22': {
        'name': 'Pier 22',
        'lat': 39.22138915580051,
        'lon': -76.52271339808404,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_23': {
        'name': 'Pier 23',
        'lat': 39.22196361060732,
        'lon': -76.52196646193843,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    }
}
